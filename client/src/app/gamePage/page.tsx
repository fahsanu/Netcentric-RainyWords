...
export default function GamePage() {
  ...
  const [countdown, setCountdown] = useState(300); // 2 minutes
  ...
  return (
    <div className="w-full h-full pb-24 min-h-screen justify-center relative bg-slate-400 dark:bg-slate-600">
      ...
      <div className="w-screen flex justify-center">
        ...
        <p className="absolute text-black text-3xl left-44 top-36">Player1 #</p>
        <p className="absolute text-black text-3xl right-44 top-36">
          Player2 #
        </p>
        <div className="p-10">
          <Cloud />
